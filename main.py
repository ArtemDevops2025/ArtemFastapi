...
@app.get("/questions/", response_model=List[Question], name="Questions all",tags=['Admin Tasks'])
...
@app.get("/questions/subject/{subject}", response_model=List[Question], name="Subjects related to questions", tags=['Admin Tasks'])
...
@app.post("/questions/", response_model=QuestionResponse, name="Add question",tags=['Admin Tasks'])
